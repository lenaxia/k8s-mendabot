...
| `trivy-agent.txt` | `trivy image ... mechanic-agent:review-scan > raw/trivy-agent.txt` | Phase 8 |
| `trivy-watcher.txt` | `trivy image ... mechanic-watcher:review-scan > raw/trivy-watcher.txt` | Phase 8 |
